...
func TestConversationSessionLabelDerivation(t *testing.T) {
	tests := []struct {
		...
		{name: "speech disabled", text: "[Speech transcription is disabled; inspect the attached audio manually]", want: ""},
		{name: "speech failed", text: "[Speech transcription failed; inspect the attached audio manually: boom]", want: ""},
		{name: "speech transcript keeps prose", text: "[Generated speech transcription; may contain errors]\nRemember to water the plants", want: "Remember to water the plants"},
